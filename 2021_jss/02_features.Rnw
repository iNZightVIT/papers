...
The simplified interface shown in \cref{fig:inzight_main} makes \pkg{iNZight} very easy to learn and, unlike more complicated alternatives, can be picked up after a period of non-use with little effort, making it ideal for infrequent but critical tasks within organisations.
