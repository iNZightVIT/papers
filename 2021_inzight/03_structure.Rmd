...
iNZight's code separation has led to an entire family of R packages, which are displayed in @cref:tab:inzight_pkgs;. Most of these packages can be used standalone, and provide simple wrappers for commonly used R workflows, replicating many of the behaviours in *R for Data Science* @citep:Hadley_2017;. Further, most of the functions return the 'tidyverse' @citep:tidyverse; code used behind-the-scences, providing a further stepping stone for users to learn these more complicated code workflows.
